script <- "$('#Groups tbody tr td:nth-last-child(2)').each(function() {
...
$('#SpeciesGroups tbody tr td:nth-last-child(1)').each(function() {
var cellValue = $(this).text().trim();
if (cellValue == '') {
$(this).css('background-color', 'rgb(255, 255, 255)');
}
...
$('#Species tbody tr td:nth-last-child(1)').each(function() {
var cellValue = $(this).text().trim();
if (cellValue == '') {
$(this).css('background-color', 'rgb(255, 255, 255)');
}
...
$('#Groups tbody tr td:last-child').each(function() {
var cellValue = $(this).text().trim();
if (cellValue == 'Bad') {
$(this).css('background-color', 'rgb(255,43,0)');
}
